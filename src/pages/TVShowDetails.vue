    ...
    <div class="flex justify-center items-center mt-10 container">
        ...
        <div class="flex gap-8 sm:flex-row flex-col w-full" v-else>
            ...
            <div class="flex flex-col">
                <div>
                    <h2 class="text-3xl text-dim-white">{{storeTVShowDetails.currentData.name}}</h2>
                ...
                <div>
                    ...
                    <p class="border-b py-4 text-dim-white border-b-dim-gray border-opacity-20">Budget: <span class="text-gray-400 ml-2">{{formattedBudget}}</span></p>
                    <p class="border-b py-4 text-dim-white border-b-dim-gray border-opacity-20">Director: <span class="text-gray-400 ml-2" v-for="director in storeTVShowDetails.currentData.created_by" :key="director">{{director.name}}</span></p>
                    <p class="border-b py-4 text-dim-white border-b-dim-gray border-opacity-20">Production companies: <span class="text-gray-400 ml-2" v-for="companies in storeTVShowDetails.currentData.production_companies" :key="companies">{{companies.name}}</span></p>
                </div>
            </div>
        </div>
    </div>
