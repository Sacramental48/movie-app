...
<template>
    <div class="flex justify-center items-center" :style="{position}">
        <svg class="hover:fill-dim-hover-fuchsia duration-300 group-hover:fill-dim-hover-fuchsia" fill="#ffffff" height="70px" width="70px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-6 -6 72.00 72.00" xml:space="preserve" stroke="#ffffff" stroke-width="0.0006000000000000001" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)">   
